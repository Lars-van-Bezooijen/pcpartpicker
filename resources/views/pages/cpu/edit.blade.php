<x-crud.edit title="CPU" action="{{ route('products.cpu.create_post') }}" :product="$cpu">
    ...
    <a href="{{ URL::previous() }}" class="flex items-center justify-center py-4 mt-2 font-extrabold text-white border-2 border-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-800 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Cancel</a>
    
    <div class="w-full flex">
        {{-- <a href="" class="block py-4 mt-2 font-extrabold text-white border-2 border-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-800 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Confirm</a>

        <a href="" class="py-4 mt-2 font-extrabold text-white border-2 border-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-800 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">
            <div class="w-6">
